...
def _do_call(delivery_id: int, phone: str, backup_numbers: list, status: str, customer_name: str, items: str, address: str) -> None:
    ...
    "model": {
        ...
        "thinkingLevel": "minimal", # ADDED: Forces sub-second latency
        "tools": [                  # ADDED: Gives the AI actual power
            {
                "type": "function",
                "function": {
    ...
    "serverMessages": ["end-of-call-report", "tool-calls"], # ADDED: Ensure VAPI sends tool executions to your webhook
